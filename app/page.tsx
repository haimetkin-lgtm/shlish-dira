    ...
    <main>
      ...
      <header className="bg-gradient-to-b from-brand-800 to-brand-700 text-white relative">
        ...
        <div className="max-w-4xl mx-auto px-4 py-20 text-center">
          ...
          <p className="text-lg text-brand-100 max-w-2xl mx-auto mb-8 leading-relaxed">
            הדרך של בני 60 ומעלה להפוך חלק מהדירה למזומן: מוכרים עד שליש מהדירה,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            {[
              ...
              },
              {
                ...
                text: "העלות הסופית תלויה באורך החיים. ככל שחיים יותר, החוב גדל יותר. גם הרגולציה מתייחסת למוצר כרגיש, המחייב זהירות וגילוי.",
              },
            ].map((c) => (
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-10 max-w-2xl mx-auto">
            למה עד שליש? כי בדיני מיסוי מקרקעין קיימת התייחסות מיוחדת להחזקה של עד שליש
            דירה, שבמקרים מתאימים אינה נחשבת דירה נוספת, ולכן המודל עשוי להיות מעניין גם
            לרוכשים. אין מדובר בהטבה אוטומטית, וכל מקרה מחייב בדיקה פרטנית. וכך זה עובד:
          </p>
          ...
          <div className="mt-8 bg-brand-800 text-white rounded-2xl p-6 sm:p-8">
            ...
            <p className="text-brand-100 text-sm text-center mb-6 max-w-2xl mx-auto">
              בחוק מיסוי מקרקעין קיימת התייחסות מיוחדת לבעלות בעד שליש דירה, שבמקרים
              מתאימים אינה נחשבת "דירה נוספת". מכך עשויות להיגזר שתי הטבות לרוכש:
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              <div className="bg-white/10 rounded-xl p-5">
                <div className="font-bold text-gold-500 mb-2">
                  אין לכם דירה? ייתכן שמדרגות "דירה יחידה" יחולו גם על השליש
                </div>
                <p className="text-brand-100 leading-relaxed">
                  במקרים מסוימים, רוכש שאין בבעלותו דירה עשוי ליהנות ממדרגות מס רכישה של
                  דירה יחידה גם ברכישת עד שליש דירה, כך שהמס בפועל עשוי להיות נמוך מאוד.
                  החבות בפועל תלויה בנתוני הרוכש, בתא המשפחתי כולו (כולל דירת בן או בת
                  הזוג), בשווי הזכויות ובתנאי הדין במועד העסקה.
                </p>
              </div>
              <div className="bg-white/10 rounded-xl p-5">
                <div className="font-bold text-gold-500 mb-2">יש לכם דירה? מעמדה עשוי להישמר</div>
                <p className="text-brand-100 leading-relaxed">
                  במקרים מתאימים, השליש אינו נספר כדירה נוספת: דירתכם הפרטית עשויה לשמור
                  על מעמד "דירה יחידה" לעניין פטור ממס שבח ומדרגות מוזלות בקנייה חליפית.
                  על השליש עצמו משולם מס רכישה של דירה נוספת. כל מקרה מחייב בדיקה פרטנית
                  של עורך דין ויועץ מס.
                </p>
              </div>
            </div>
      ...
      <footer className="text-center py-6 text-xs text-gray-400 border-t border-gray-100 px-4 leading-relaxed">
        ...
        <p className="max-w-2xl mx-auto mb-2">
          ...
          בעסקה. האחריות לקבלת ייעוץ אישי מותאם פרטני חלה על המוכר ו/או על הרוכש. כל עסקה
          מותנית בשומת מקרקעין. על כל צד לעסקה להצטייד בייצוג וייעוץ משפטי מטעמו.
        </p>
        <p>
